                ...
                <div>
                    ...
                    <table>
                        ...
                        <tr v-for="lawWait in lawWaitList" :key="lawWait.lawyerId">
                            ...
                            <td>
                                <button @click="fnApprove(lawWait.lawyerId)">승인</button>
                            </td>
                        </tr>
                    </table>
                    <!-- 승인 대기 목록 페이징 -->
                    <div class="pagination">
                        <a v-if="waitPage != 1" href="javascript:;" @click="fnWaitPageMove('prev')" class="page-btn">&lt;</a>
                        <a v-for="num in waitPageCount" :class="{active: waitPage === num}" 
                            href="javascript:;" @click="fnWaitPage(num)" class="page-btn">{{ num }}</a>
                        <a v-if="waitPage != waitPageCount" href="javascript:;" @click="fnWaitPageMove('next')" class="page-btn">&gt;</a>
                    </div>
                    <!-- 승인 완료 변호사 목록 -->
                    ...
                    <div class="pagination">
                        <a v-if="passedPage != 1" href="javascript:;" @click="fnPassedPageMove('prev')" class="page-btn">&lt;</a>
                        <a v-for="num in passedPageCount" :class="{active: passedPage === num}" 
                            href="javascript:;" @click="fnPassedPage(num)" class="page-btn">{{ num }}</a>
                        <a v-if="passedPage != passedPageCount" href="javascript:;" @click="fnPassedPageMove('next')" class="page-btn">&gt;</a>
                    </div>
                    <!-- 탈퇴 변호사 목록 -->
                    ...
                    <div class="pagination">
                        <a v-if="outPage != 1" href="javascript:;" @click="fnOutPageMove('prev')" class="page-btn">&lt;</a>
                        <a v-for="num in outPageCount" :class="{active: outPage === num}" 
                            href="javascript:;" @click="fnOutPage(num)" class="page-btn">{{ num }}</a>
                        <a v-if="outPage != outPageCount" href="javascript:;" @click="fnOutPageMove('next')" class="page-btn">&gt;</a>
                    </div>
                </div>
            </div>
        </div>
