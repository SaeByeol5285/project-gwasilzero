        ...
        <div class="comment-list" v-if="comments.length > 0">
          ...
          <div class="comment-item" v-for="(cmt, index) in comments" :key="index">
            <div class="comment-meta">
              ...
              <!-- 계약 아이콘 -->
              <img v-if="sessionType === 'user'" src="/img/contract.png" @click="startContract(cmt.lawyerId)"
                title="계약하기" style="width: 18px; height: 18px; margin-left: 8px; cursor: pointer;" />

              <!-- 채팅 아이콘 -->
              <img v-if="sessionType === 'user'" src="/img/icon-chat.png" @click="startChat(cmt.lawyerId)" title="채팅하기"
                style="width: 18px; height: 18px; margin-left: 8px; cursor: pointer;" />
            </div>
    ...
    const app = Vue.createApp({
      ...
      mounted() {
        ...
        const urlParams = new URLSearchParams(window.location.search);
				const boardNoParam = urlParams.get("boardNo");
				self.boardNo = boardNoParam;
        console.log(self.sessionType);
        self.fnGetBoard();
