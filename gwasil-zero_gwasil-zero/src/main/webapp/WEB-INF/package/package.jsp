      ...
      <div class="package-container">
         <template v-for="item in list" :key="item.packageName">
            <div class="package-box" v-if="item.packageStatus === 'U'">
               ...
               <!-- 사용자용 패키지: 일반 사용자만 구매 가능 -->
               <a 
               v-if="role === 'user' && !isPurchased(item)" 
               href="javascript:;" 
               @click="fnBuy(item)" 
               class="buy-btn">
               구매하기
               ...
               <span 
               v-else-if="role === 'user' && isPurchased(item)" 
               class="buy-btn" 
               style="background-color: #ccc; cursor: default;">
               구매 완료
               </span>
               <span 
               v-else 
      ...
      <div class="lawyer-package-container">
         <template v-for="item in list" :key="item.packageName">
            <div class="package-box" v-if="item.packageStatus === 'L'">
               ...
               <!-- 변호사용 패키지: 변호사만 구매 가능 -->
               <a 
               v-if="role === 'lawyer' && !isPurchased(item)" 
               href="javascript:;" 
               @click="fnBuy(item)" 
               class="buy-btn">
               구매하기
               ...
               <span 
               v-else-if="role === 'lawyer' && isPurchased(item)" 
               class="buy-btn" 
               style="background-color: #ccc; cursor: default;">
               구매 완료
               </span>
